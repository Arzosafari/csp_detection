...
class SensorNetworkGUI:
    def __init__(self, root, params):
        self.root = root
        self.root.title("Sensor Network Simulation")
    ...
    def draw_static(self):
        for idx, (x, y) in enumerate(self.sensors):
            ...
            self.canvas.create_text(
                ...
                text=f"{idx+1}", fill="black", font=("Arial", 8)
            )
    ...
    def update(self):
        self.canvas.delete("thief", "arrow")
    ...
    def draw_detection_arrows(self, thief_idx, sensor_ids):
        ...
        for sid in sensor_ids:
            sx, sy = self.sensors[sid]
            x1 = sx * CELL_SIZE + CELL_SIZE // 2
            y1 = sy * CELL_SIZE + CELL_SIZE // 2
            x2 = tx * CELL_SIZE + CELL_SIZE // 2
            y2 = ty * CELL_SIZE + CELL_SIZE // 2
            self.canvas.create_line(x1, y1, x2, y2, arrow=tk.LAST, fill="orange", width=2, tags="arrow")
